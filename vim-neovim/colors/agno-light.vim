" Agno Light - Vim/Neovim colorscheme
set background=light
highlight clear
if exists("syntax_on")
  syntax reset
endif
let g:colors_name = "agno-light"

hi Normal guifg=#18181B guibg=#FCFCFC
hi Cursor guifg=#FCFCFC guibg=#FF4017
hi CursorLine guibg=#F9F9F9
hi LineNr guifg=#8D8D8D guibg=#FCFCFC
hi CursorLineNr guifg=#FF4017 guibg=#FCFCFC
...
hi StatusLine guifg=#FFFFFF guibg=#18181B
hi VertSplit guifg=#D9D9D9 guibg=#FCFCFC
hi ColorColumn guibg=#F0F0F0
hi SignColumn guibg=#FCFCFC
